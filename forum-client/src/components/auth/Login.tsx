...
const Login: FC<ModalProps> = ({ isOpen, onClickToggle }) => {
    // using object destructing allows me the use of some fields from userReducer but not all since login only needs a subset
    const [
        {userName, password, resultMsg, isSubmitDisabled }, dispatch, ] = useReducer(userReducer, {
            userName: "",
            password: "",
            resultMsg: "",
